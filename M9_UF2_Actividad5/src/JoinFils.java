...
public class JoinFils implements Runnable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		JoinFils obj16 = new JoinFils(ans);
		JoinFils obj17 = new JoinFils(ans);
		...
		Thread fil_16 = new Thread(obj16);
		fil_16.setName("Dau 16");
		Thread fil_17 = new Thread(obj17);
		fil_17.setName("Dau 17");
